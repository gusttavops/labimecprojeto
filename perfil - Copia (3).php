...
$usuario_logado_id = $_SESSION['usuario'];
...
<div class="sidebar">
  <div>
    <div class="user-profile">
      ...
      <div class="edit-photo" onclick="document.getElementById('editarFotos').style.display='flex';">Perfil</div>
      <h3><?= htmlspecialchars($nome) ?></h3>
    </div>
    <button onclick="window.location.href='inicio.php'"><i class="fas fa-home"></i> Início</button>
    <button><i class="fas fa-comments"></i> Mensagens</button>
    <button><i class="fas fa-user-friends"></i> Contatos</button>
    <button onclick="window.location.href='registrar_desaparecido.php'"><i class="fas fa-user-plus"></i> Registrar Desaparecimento</button>
